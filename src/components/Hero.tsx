  ...
  return (
    <div className='flex w-[100%] h-[90vh] xs:h-[80vh] md:h-[100vh]'>
        <div className={`text-white mt-[10vh] h-auto w-[50vw] bg-[#191919] hidden md:flex md:flex-col justify-center ${ptSans.className}`}>
            <div className='w-[80%] ml-auto'>
              ...
              <div className='text-lg w-[70%]'>
                Organised by Department of Information Technology, Ajay Kumar Garg Engineering College, Ghaziabad, Uttar Pradesh, India
              </div>
        ...
        <Image
            ...
            height={730}
         />
         <div className='mt-[20vh] xs:mt-[15vh] h-[80vh] xs:h-auto md:hidden text-white' style={{
          backgroundImage: 'url("conf.png")'
            ...
            <div className='w-[80%] ml-5'>
              ...
              <div className='text-lg w-[70%]'>24 & 25 May 2024</div>
              <div className='pt-8'>
